...
const MOCK_DATA: Record<string, Track[]> = {
  "Pop-0": [
    ...
    { title: "Stay", artist: "The Kid LAROI", gradient: "linear-gradient(135deg,#fff9c4 0%,#fff176 100%)" },
    { title: "Bad Habits", artist: "Ed Sheeran", gradient: "linear-gradient(135deg,#fce4ec 0%,#f48fb1 100%)" },
    { title: "Heat Waves", artist: "Glass Animals", gradient: "linear-gradient(135deg,#e3f2fd 0%,#90caf9 100%)" },
    { title: "Watermelon Sugar", artist: "Harry Styles", gradient: "linear-gradient(135deg,#f9fbe7 0%,#f0f4c3 100%)" },
    { title: "drivers license", artist: "Olivia Rodrigo", gradient: "linear-gradient(135deg,#ede7f6 0%,#b39ddb 100%)" },
  ],
  "Pop-1": [
    ...
    { title: "Heather", artist: "Conan Gray", gradient: "linear-gradient(135deg,#e8f5e9 0%,#c8e6c9 100%)" },
    { title: "Superstar", artist: "Carpenters", gradient: "linear-gradient(135deg,#fff8e1 0%,#ffecb3 100%)" },
    { title: "traitor", artist: "Olivia Rodrigo", gradient: "linear-gradient(135deg,#fce4ec 0%,#f8bbd0 100%)" },
    { title: "2step", artist: "Ed Sheeran", gradient: "linear-gradient(135deg,#e3f2fd 0%,#bbdefb 100%)" },
  ...
  "Rock-0": [
    ...
    { title: "Come As You Are", artist: "Nirvana", gradient: "linear-gradient(135deg,#b2dfdb 0%,#80cbc4 100%)" },
    { title: "Under the Bridge", artist: "Red Hot Chili Peppers", gradient: "linear-gradient(135deg,#ff8a80 0%,#ff5252 100%)" },
    { title: "Creep", artist: "Radiohead", gradient: "linear-gradient(135deg,#cfd8dc 0%,#90a4ae 100%)" },
    { title: "Black", artist: "Pearl Jam", gradient: "linear-gradient(135deg,#37474f 0%,#263238 100%)" },
  ...
  "Rock-1": [
    ...
    { title: "Vapour Trail", artist: "Ride", gradient: "linear-gradient(135deg,#e1f5fe 0%,#b3e5fc 100%)" },
    { title: "Fluorescent Adolescent", artist: "Arctic Monkeys", gradient: "linear-gradient(135deg,#f06292 0%,#e91e63 100%)" },
    { title: "When The Sun Goes Down", artist: "Arctic Monkeys", gradient: "linear-gradient(135deg,#ff8f00 0%,#ff6f00 100%)" },
    { title: "Knee Socks", artist: "Arctic Monkeys", gradient: "linear-gradient(135deg,#78909c 0%,#546e7a 100%)" },
  ],
  "Rock-2": [
    ...
    { title: "No Children", artist: "The Mountain Goats", gradient: "linear-gradient(135deg,#efebe9 0%,#d7ccc8 100%)" },
    { title: "White Winter Hymnal", artist: "Fleet Foxes", gradient: "linear-gradient(135deg,#e8eaf6 0%,#c5cae9 100%)" },
    ...
    { title: "Tiger Mountain Peasant Song", artist: "Fleet Foxes", gradient: "linear-gradient(135deg,#f1f8e9 0%,#dcedc8 100%)" },
    { title: "Heretic Pride", artist: "The Mountain Goats", gradient: "linear-gradient(135deg,#fff3e0 0%,#ffe0b2 100%)" },
  ],
  "Hip-Hop-0": [
    ...
    { title: "DNA.", artist: "Kendrick Lamar", gradient: "linear-gradient(135deg,#b71c1c 0%,#d32f2f 100%)" },
    { title: "Rockstar", artist: "Post Malone ft. 21 Savage", gradient: "linear-gradient(135deg,#4a148c 0%,#6a1b9a 100%)" },
    { title: "Industry Baby", artist: "Lil Nas X", gradient: "linear-gradient(135deg,#1565c0 0%,#1976d2 100%)" },
    ...
    { title: "MONTERO", artist: "Lil Nas X", gradient: "linear-gradient(135deg,#880e4f 0%,#ad1457 100%)" },
  ],
  "Hip-Hop-1": [
    ...
    { title: "Shadow of a Doubt", artist: "Noname", gradient: "linear-gradient(135deg,#f3e5f5 0%,#e1bee7 100%)" },
    { title: "THat'XXX", artist: "Isaiah Rashad", gradient: "linear-gradient(135deg,#fce4ec 0%,#f8bbd0 100%)" },
    { title: "Telefone", artist: "Noname", gradient: "linear-gradient(135deg,#e8eaf6 0%,#c5cae9 100%)" },
    { title: "Free Lunch", artist: "Isaiah Rashad", gradient: "linear-gradient(135deg,#e1f5fe 0%,#b3e5fc 100%)" },
  ],
  "Hip-Hop-2": [
    ...
    { title: "Talk to Me", artist: "Armand Hammer", gradient: "linear-gradient(135deg,#3e2723 0%,#4e342e 100%)" },
    { title: "Furtive Movements", artist: "billy woods", gradient: "linear-gradient(135deg,#263238 0%,#37474f 100%)" },
    { title: "Outside", artist: "Milo", gradient: "linear-gradient(135deg,#f3e5f5 0%,#e1bee7 100%)" },
    { title: "Swerve City", artist: "Doomtree", gradient: "linear-gradient(135deg,#e2b96f 0%,#c8843e 100%)" },
    { title: "An Idea", artist: "Pink Siifu", gradient: "linear-gradient(135deg,#e8f5e9 0%,#c8e6c9 100%)" },
  ],
  "Indie-0": [
    ...
    { title: "Kids", artist: "MGMT", gradient: "linear-gradient(135deg,#ce93d8 0%,#ab47bc 100%)" },
    { title: "Take Me Out", artist: "Franz Ferdinand", gradient: "linear-gradient(135deg,#f72585 0%,#560bad 100%)" },
    { title: "Pumped Up Kicks", artist: "Foster the People", gradient: "linear-gradient(135deg,#80cbc4 0%,#4db6ac 100%)" },
    { title: "Such Great Heights", artist: "The Postal Service", gradient: "linear-gradient(135deg,#81d4fa 0%,#4fc3f7 100%)" },
    { title: "Home", artist: "Edward Sharpe & The Magnetic Zeros", gradient: "linear-gradient(135deg,#ffe082 0%,#ffd54f 100%)" },
  ],
  "Indie-1": [
    ...
    { title: "Lua", artist: "Bright Eyes", gradient: "linear-gradient(135deg,#ffecd2 0%,#fcb69f 100%)" },
    { title: "Moon River", artist: "Frank Ocean", gradient: "linear-gradient(135deg,#e3f2fd 0%,#bbdefb 100%)" },
    ...
    { title: "Four Women", artist: "Nina Simone", gradient: "linear-gradient(135deg,#e8eaf6 0%,#c5cae9 100%)" },
  ],
  "Indie-2": [
    { title: "Stranger", artist: "Jordana", gradient: "linear-gradient(135deg,#f7cad0 0%,#ffe8d6 100%)" },
    { title: "Savior Complex", artist: "Phoebe Bridgers", gradient: "linear-gradient(135deg,#c3b1e1 0%,#e8d5f5 100%)" },
    { title: "Honey", artist: "Hovvdy", gradient: "linear-gradient(135deg,#fff9c4 0%,#fff59d 100%)" },
    { title: "Clarity", artist: "Raveena", gradient: "linear-gradient(135deg,#fce4ec 0%,#f8bbd0 100%)" },
    { title: "We Fell in Love in October", artist: "girl in red", gradient: "linear-gradient(135deg,#f3e5f5 0%,#e1bee7 100%)" },
    { title: "Some", artist: "girl in red", gradient: "linear-gradient(135deg,#e91e63 0%,#c2185b 100%)" },
    { title: "Dark Red", artist: "Steve Lacy", gradient: "linear-gradient(135deg,#b71c1c 0%,#c62828 100%)" },
    { title: "Nobody's Watching", artist: "Waxahatchee", gradient: "linear-gradient(135deg,#fff3e0 0%,#ffe0b2 100%)" },
    { title: "Devotion", artist: "Hurray for the Riff Raff", gradient: "linear-gradient(135deg,#e8f5e9 0%,#c8e6c9 100%)" },
    { title: "Bound 2", artist: "Kanye West", gradient: "linear-gradient(135deg,#ff8f00 0%,#ff6f00 100%)" },
  ],
  "R&B-0": [
    ...
    { title: "Snooze", artist: "SZA", gradient: "linear-gradient(135deg,#b39ddb 0%,#9575cd 100%)" },
    { title: "Peaches", artist: "Justin Bieber ft. Daniel Caesar", gradient: "linear-gradient(135deg,#ffa726 0%,#fb8c00 100%)" },
    { title: "Love Again", artist: "Dua Lipa", gradient: "linear-gradient(135deg,#f8bbd0 0%,#f48fb1 100%)" },
    { title: "Calling My Phone", artist: "Lil Tjay ft. 6LACK", gradient: "linear-gradient(135deg,#ce93d8 0%,#ba68c8 100%)" },
    { title: "I Ain't Worried", artist: "OneRepublic", gradient: "linear-gradient(135deg,#80deea 0%,#4dd0e1 100%)" },
  ],
  "R&B-1": [
    ...
    { title: "Colors", artist: "Halsey", gradient: "linear-gradient(135deg,#e3f2fd 0%,#90caf9 100%)" },
    { title: "You Should Be Sad", artist: "Halsey", gradient: "linear-gradient(135deg,#ffe8d6 0%,#f8c8a0 100%)" },
    { title: "Crybaby", artist: "Melanie Martinez", gradient: "linear-gradient(135deg,#f8bbd0 0%,#f06292 100%)" },
    { title: "Soap", artist: "Melanie Martinez", gradient: "linear-gradient(135deg,#b3e5fc 0%,#81d4fa 100%)" },
    { title: "Wrong", artist: "MAX ft. Lil Uzi Vert", gradient: "linear-gradient(135deg,#1a237e 0%,#283593 100%)" },
  ],
  "R&B-2": [
    ...
    { title: "Butterfly Effect", artist: "Hiatus Kaiyote", gradient: "linear-gradient(135deg,#b2dfdb 0%,#80cbc4 100%)" },
    { title: "In the Meantime", artist: "Nai Palm", gradient: "linear-gradient(135deg,#a8d8ea 0%,#7ec8e3 100%)" },
    { title: "Molasses", artist: "Nai Palm", gradient: "linear-gradient(135deg,#fce4ec 0%,#f8bbd0 100%)" },
    { title: "See Me Now", artist: "Kadhja Bonet", gradient: "linear-gradient(135deg,#d7bde2 0%,#bb8fce 100%)" },
    { title: "Shaolin Monk Motherfunk", artist: "Hiatus Kaiyote", gradient: "linear-gradient(135deg,#ffe0b2 0%,#ffcc80 100%)" },
  ],
  "Jazz-0": [
    ...
    { title: "A Love Supreme", artist: "John Coltrane", gradient: "linear-gradient(135deg,#1a237e 0%,#283593 100%)" },
    { title: "Kind of Blue", artist: "Miles Davis", gradient: "linear-gradient(135deg,#0d47a1 0%,#1565c0 100%)" },
    { title: "Fly Me to the Moon", artist: "Frank Sinatra", gradient: "linear-gradient(135deg,#e3f2fd 0%,#90caf9 100%)" },
    { title: "Summertime", artist: "Ella Fitzgerald", gradient: "linear-gradient(135deg,#ffe082 0%,#ffd54f 100%)" },
    { title: "What a Wonderful World", artist: "Louis Armstrong", gradient: "linear-gradient(135deg,#a5d6a7 0%,#81c784 100%)" },
  ],
  "Jazz-1": [
    ...
    { title: "Speak No Evil", artist: "Wayne Shorter", gradient: "linear-gradient(135deg,#2c3e50 0%,#3498db 100%)" },
    { title: "Alice in Wonderland", artist: "Bill Evans", gradient: "linear-gradient(135deg,#ce93d8 0%,#ab47bc 100%)" },
    { title: "Joy Spring", artist: "Clifford Brown", gradient: "linear-gradient(135deg,#ffe082 0%,#ffc107 100%)" },
    { title: "Cherokee", artist: "Charlie Parker", gradient: "linear-gradient(135deg,#4caf50 0%,#388e3c 100%)" },
    { title: "Celia", artist: "Cécile McLorin Salvant", gradient: "linear-gradient(135deg,#f5cba7 0%,#e59866 100%)" },
    { title: "Infant Eyes", artist: "Wayne Shorter", gradient: "linear-gradient(135deg,#1a1a2e 0%,#16213e 100%)" },
    { title: "Nardis", artist: "Bill Evans", gradient: "linear-gradient(135deg,#283593 0%,#1565c0 100%)" },
  ],
  "Jazz-2": [
    ...
    { title: "Wu Hen", artist: "Kamaal Williams", gradient: "linear-gradient(135deg,#880e4f 0%,#ad1457 100%)" },
    { title: "Return to Nowhere", artist: "Sun Ra", gradient: "linear-gradient(135deg,#1a237e 0%,#311b92 100%)" },
    { title: "Open Channels", artist: "Shabaka and The Ancestors", gradient: "linear-gradient(135deg,#37474f 0%,#263238 100%)" },
    { title: "Alone Again Or", artist: "Love", gradient: "linear-gradient(135deg,#f57f17 0%,#ff8f00 100%)" },
    { title: "A House Is Not a Motel", artist: "Love", gradient: "linear-gradient(135deg,#bf360c 0%,#d84315 100%)" },
  ],
};
...
function playAudioPreview(url: string) {
  ...
  _fadeTimer = setInterval(() => {
    ...
    if (vol >= 0.72) { clearInterval(_fadeTimer!); _fadeTimer = null; }
  }, 45);
}
...
function stopAudioPreview() {
  ...
  _fadeTimer = setInterval(() => {
    ...
    audio.volume = vol;
    if (vol <= 0) { clearInterval(_fadeTimer!); _fadeTimer = null; audio.pause(); if (_audio === audio) _audio = null; }
  }, 45);
}

// ── SongCard ──────────────────────────────────────────────────────────────────
function SongCard({
  song, C, onHeard, onAdd,
}: { song: Track; C: Theme; onHeard: () => void; onAdd: () => void }) {
  ...
  const handleHeard = (e: React.MouseEvent) => {
    e.stopPropagation();
    stopAudioPreview(); setPlaying(false); onHeard();
  };

  const handleMouseEnter = () => {
    if (song.previewUrl) { playAudioPreview(song.previewUrl); setPlaying(true); }
  };

  const handleMouseLeave = () => { stopAudioPreview(); setPlaying(false); };
  ...
  return (
    ...
    >
      <div className="relative" style={{ aspectRatio: "1 / 1", background: song.gradient }}>
        <img
        ...
        <button
          ...
          style={{ width: 26, height: 26, borderRadius: "50%", background: "rgba(251,249,246,0.90)", backdropFilter: "blur(6px)", border: "1px solid rgba(44,36,32,0.12)", color: "#8A7E79", fontSize: 12, boxShadow: "0 1px 4px rgba(44,36,32,0.14)" }}
        >
          ✓
        </button>
        ...
        {/* Audio pill */}
        {song.previewUrl && (
          <div className="absolute bottom-2 left-2 transition-opacity duration-200" style={{ opacity: playing ? 1 : 0 }}>
            <span style={{ background: "rgba(251,249,246,0.90)", backdropFilter: "blur(6px)", borderRadius: "99px", padding: "2px 8px 2px 6px", fontSize: "0.62rem", fontWeight: 600, color: C.accent, letterSpacing: "0.04em", border: `1px solid ${C.accent}30` }}>
              ♪ Preview
            </span>
          </div>
        )}
      ...
      <div className="flex flex-col gap-2.5 p-3.5">
        <div>
          ...
          <div className="flex items-start gap-1.5">
            <h3 className="font-semibold line-clamp-1 flex-1 text-[14px] leading-snug" style={{ color: C.text }} title={song.title}>
              {song.title}
            </h3>
            {song.spotifyUrl && (
              <a
          ...
          <p className="text-xs line-clamp-1 mt-0.5" style={{ color: C.textMuted }} title={song.artist}>
            {song.artist}
          </p>
        </div>
        <button
          ...
          style={{ backgroundColor: added ? C.accentHover : C.accent, color: "white", letterSpacing: "0.01em" }}
        >
...
function SkeletonCard({ C }: { C: Theme }) {
  return (
    <div style={{ background: C.bgCard, borderRadius: "12px", outline: `1px solid ${C.border}`, overflow: "hidden", transition: "background 0.3s" }}>
      <div style={{ aspectRatio: "1/1", background: C.bgInput }} className="animate-pulse" />
      <div className="p-3.5 flex flex-col gap-2.5">
        <div className="h-3.5 w-3/4 rounded-full animate-pulse" style={{ background: C.border }} />
        <div className="h-3 w-1/2 rounded-full animate-pulse" style={{ background: C.border }} />
        <div className="h-8 w-full rounded-full animate-pulse mt-0.5" style={{ background: C.border }} />
      </div>
    </div>
  );
}
...
function PlaylistDrawer({
  open, C, tracks, oauthToken, onClose, onRemove,
}: {
  open: boolean; C: Theme; tracks: Track[]; oauthToken: string | null; onClose: () => void; onRemove: (i: number) => void;
}) {
  ...
  const handleExport = async () => {
    if (!oauthToken) { setExportErr("Connect Spotify to export your playlist."); return; }
    if (tracks.length === 0) { setExportErr("Add some tracks first!"); return; }
    setExporting(true); setExportErr(null); setExportUrl(null);
    try {
      const userId = await getCurrentUserId(oauthToken);
      const date   = new Date().toLocaleDateString("en-US", { month: "short", day: "numeric" });
      const { id, url } = await createSpotifyPlaylist(oauthToken, userId, `Niche Finds – ${date}`);
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            style={{ width: 340, background: C.drawerBg, boxShadow: "-4px 0 32px rgba(0,0,0,0.18)", borderLeft: `1px solid ${C.border}`, transition: "background 0.3s" }}
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: `1px solid ${C.border}` }}>
              <div>
                <p style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontSize: "1.1rem", fontWeight: 700, color: C.text }}>
                  My Saved Discoveries
                </p>
                <p style={{ fontSize: "0.72rem", color: C.textMuted, marginTop: 2 }}>
                  {tracks.length} track{tracks.length !== 1 ? "s" : ""} saved
                </p>
              </div>
              <button onClick={onClose} className="flex items-center justify-center hover:opacity-60 transition-opacity" style={{ width: 28, height: 28, borderRadius: "50%", background: C.bgInput, border: `1px solid ${C.border}`, color: C.textMuted, fontSize: 14 }}>
                ×
              </button>
            </div>

            {/* Track list */}
            <div className="flex-1 overflow-y-auto" style={{ padding: "12px 16px", gap: 8, display: "flex", flexDirection: "column" }}>
              {tracks.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full gap-3 text-center" style={{ padding: "40px 24px" }}>
                  <p style={{ fontSize: "2rem" }}>♪</p>
                  <p style={{ color: C.textMuted, fontSize: "0.85rem", lineHeight: 1.5 }}>
                    Your saved discoveries will appear here. Hit "+ Add to Playlist" on any card.
                  </p>
                </div>
              ) : (
                <AnimatePresence>
                  {tracks.map((t, i) => (
                    <motion.div
                      ...
                      style={{ background: C.bgInput, outline: `1px solid ${C.border}` }}
                    >
                      <div className="flex-shrink-0" style={{ width: 42, height: 42, borderRadius: 8, overflow: "hidden", background: t.gradient }}>
                        {t.albumArt && <img src={t.albumArt} alt={t.title} className="w-full h-full object-cover" />}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-semibold line-clamp-1" style={{ color: C.text }}>{t.title}</p>
                        <p className="text-xs line-clamp-1 mt-0.5" style={{ color: C.textMuted }}>{t.artist}</p>
                      </div>
                      <div className="flex items-center gap-1.5 flex-shrink-0">
                        {t.spotifyUrl && (
                          <a href={t.spotifyUrl} target="_blank" rel="noopener noreferrer" className="opacity-40 hover:opacity-90 transition-opacity" onClick={e => e.stopPropagation()}>
                            <SiSpotify size={13} color="#1DB954" />
                          </a>
                        )}
                        <button
                          ...
                          style={{ color: C.textMuted, fontSize: 14, lineHeight: 1, width: 20, height: 20, display: "flex", alignItems: "center", justifyContent: "center" }}
                        >
                          ×
                        </button>
                      </div>
            ...
            <div className="px-4 py-4" style={{ borderTop: `1px solid ${C.border}` }}>
              {exportErr && <p style={{ color: "#E65100", fontSize: "0.72rem", marginBottom: 8, textAlign: "center" }}>{exportErr}</p>}
              {exportUrl ? (
                <a
                  href={exportUrl} target="_blank" rel="noopener noreferrer"
                  ...
                  style={{ background: "#1DB954", color: "white", textDecoration: "none", boxShadow: "0 2px 12px rgba(29,185,84,0.32)" }}
                >
                ...
                <button
                  ...
                  style={{ background: "#1DB954", color: "white", boxShadow: "0 2px 12px rgba(29,185,84,0.32)" }}
                >
                  <SiSpotify size={16} />
              ...
              {!oauthToken && (
                <p style={{ color: C.textMuted, fontSize: "0.68rem", textAlign: "center", marginTop: 8 }}>
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    handleOAuthCallback(code).then(token => {
      if (token) { setOauthToken(token); setOauthAuthed(true); }
  ...
  const handleConnect = async () => {
    if (!hasClientId()) { alert("VITE_SPOTIFY_CLIENT_ID is not configured."); return; }
    try { await initiateSpotifyAuth(); } catch (e) { console.error(e); }
  };
  const handleDisconnect = () => { clearAuth(); setOauthToken(null); setOauthAuthed(false); };

  const handleSurprise = () => {
    setActiveGenre(GENRES[Math.floor(Math.random() * GENRES.length)]);
    setObscurity(Math.floor(Math.random() * 3));
    setCustomGenre(""); setLanguage("All");
  };

  const addToPlaylist = (track: Track) => {
    setPlaylist(prev => prev.some(t => t.spotifyId === track.spotifyId && t.title === track.title) ? prev : [...prev, track]);
  };
  ...
  return (
    <div
      ...
      style={{ background: C.bg, fontFamily: "'Inter', sans-serif", transition: "background 0.35s, color 0.35s" }}
    >
      {/* Playlist Drawer */}
      <PlaylistDrawer
        open={drawerOpen} C={C} tracks={playlist} oauthToken={oauthToken}
        onClose={() => setDrawerOpen(false)}
        onRemove={i => setPlaylist(prev => prev.filter((_, idx) => idx !== i))}
      />
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-10 md:py-14 flex flex-col md:flex-row gap-10 md:gap-14">
        ...
        <aside className="w-full md:w-[300px] flex-shrink-0 flex flex-col gap-7">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "3rem", fontWeight: 700, fontStyle: "italic", lineHeight: 1, color: C.text, letterSpacing: "-0.035em", transition: "color 0.35s" }}>
                niche
              </h1>
              <p style={{ color: C.textMuted, marginTop: 6, fontSize: "0.85rem", lineHeight: 1.5, transition: "color 0.35s" }}>
            ...
            <button
              ...
              style={{ width: 36, height: 36, borderRadius: "50%", background: C.bgInput, border: `1.5px solid ${C.border}`, color: C.textMuted, fontSize: 16, boxShadow: C.shadow, transition: "background 0.35s, border 0.35s" }}
            >
              {darkMode ? "☀" : "☾"}
            </button>
          </div>
          ...
          {oauthAuthed ? (
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-full" style={{ background: C.badgeBg, border: `1.5px solid ${C.badgeBorder}` }}>
                <SiSpotify size={15} color={C.green} />
                <span style={{ color: C.badgeText, fontSize: "0.85rem", fontWeight: 500 }}>Spotify Connected</span>
              </div>
              <button onClick={handleDisconnect} className="text-xs underline hover:opacity-70 transition-opacity text-left" style={{ color: C.textLabel }}>Disconnect</button>
            </div>
          ) : (
            <button
              ...
              style={{ backgroundColor: "#1DB954", color: "white", fontSize: "0.9rem", boxShadow: "0 2px 12px rgba(29,185,84,0.28)" }}
            >
          ...
          {usingLiveApi && !oauthAuthed && (
            <div style={{ background: C.badgeBg, border: `1px solid ${C.badgeBorder}`, borderRadius: 8, padding: "7px 12px", transition: "background 0.35s" }}>
              <p style={{ color: C.badgeText, fontSize: "0.72rem", fontWeight: 500 }}>✓ Live Spotify data active</p>
            </div>
          )}
          {apiError && (
            <div style={{ background: "#FFF3E0", border: "1px solid #FFCC80", borderRadius: 8, padding: "7px 12px" }}>
              <p style={{ color: "#E65100", fontSize: "0.72rem" }}>Spotify API error — showing curated picks</p>
            </div>
          )}

          {/* Genre chips */}
          <div className="flex flex-col gap-2.5">
            <p className="uppercase tracking-widest" style={{ fontSize: "0.63rem", fontWeight: 600, color: C.textLabel, letterSpacing: "0.13em", transition: "color 0.35s" }}>
              Start with a Vibe
            </p>
              ...
              {GENRES.map(genre => {
                ...
                return (
                  <button
                    ...
                    style={isActive
                      ? { backgroundColor: C.bgChipActive, color: C.textChipActive, border: `1.5px solid ${C.bgChipActive}`, boxShadow: darkMode ? "0 2px 8px rgba(29,185,84,0.24)" : "0 2px 8px rgba(193,97,79,0.24)" }
                      : { backgroundColor: C.bgChip, color: C.textChip, border: `1.5px solid ${C.border}`, transition: "background 0.35s, border 0.35s, color 0.35s" }}
                  >
                    {genre}
                  </button>
                );
              ...
              {LANGUAGES.map(lang => {
                ...
                return (
                  <button
                    ...
                    style={isActive
                      ? { backgroundColor: C.bgChipActive, color: C.textChipActive, border: `1.5px solid ${C.bgChipActive}` }
                      : { backgroundColor: C.bgChip, color: C.textChip, border: `1.5px solid ${C.border}` }}
                  >
                    {lang}
                  </button>
                );
          ...
          <div className="flex flex-col gap-2">
            ...
            <form onSubmit={e => e.preventDefault()} className="flex gap-2">
              <input
                type="text" value={customGenre} onChange={e => setCustomGenre(e.target.value)}
                placeholder="e.g. Bossa Nova, Shoegaze…"
                className="flex-1 py-2.5 px-4 rounded-full text-sm outline-none"
                style={{ background: C.bgInput, border: `1.5px solid ${C.borderInput}`, color: C.text, fontFamily: "'Inter', sans-serif", transition: "background 0.35s, border 0.35s" }}
                onFocus={e => { e.currentTarget.style.borderColor = C.accent; e.currentTarget.style.boxShadow = `0 0 0 3px ${C.focusRing}`; }}
                onBlur={e => { e.currentTarget.style.borderColor = C.borderInput; e.currentTarget.style.boxShadow = "none"; }}
              />
              {customGenre.trim() && (
                <button type="submit" className="px-4 py-2.5 rounded-full text-sm font-medium transition-all active:scale-95" style={{ backgroundColor: C.accent, color: "white" }}>Go</button>
              )}
            </form>
          </div>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <input
              type="range" min="0" max="2" step="1" value={obscurity}
              onChange={e => setObscurity(Number(e.target.value))}
              className="custom-range"
              style={{ background: `linear-gradient(to right, ${C.accent} ${(obscurity / 2) * 100}%, ${C.border} ${(obscurity / 2) * 100}%)` }}
            />
            <div className="flex justify-between">
              {OBSCURITY_LABELS.map((label, i) => (
                <span key={label} style={{ fontSize: "0.72rem", fontWeight: obscurity === i ? 600 : 400, color: obscurity === i ? C.accent : C.textLabel, transition: "color 0.15s" }}>
                  {label}
                </span>
              ))}
            </div>
          ...
          <button
            ...
            style={{ background: C.bgButton, border: `1.5px solid ${C.border}`, color: C.text, boxShadow: C.shadow, letterSpacing: "0.02em", transition: "background 0.35s, border 0.35s, color 0.35s" }}
          >
            ✦ Surprise Me
          </button>
        </aside>
        ...
        <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-end justify-between mb-5 gap-4">
            <div>
              <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "2.1rem", fontWeight: 700, color: C.text, lineHeight: 1.1, letterSpacing: "-0.02em", transition: "color 0.35s" }}>
                Your Fresh Finds
              </h2>
              <p style={{ color: C.textMuted, marginTop: 6, fontSize: "0.9rem", transition: "color 0.35s" }}>
                Digging into{" "}
                <span style={{ color: C.text, fontWeight: 600 }}>{displayGenre}</span>
                {" "}<span style={{ color: C.accent }}>•</span>{" "}
                <span>{obscurityLabel(obscurity)}</span>
                {language !== "All" && <>{" "}<span style={{ color: C.accent }}>•</span>{" "}<span>{language}</span></>}
              </p>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                ...
                style={{ background: C.bgButton, border: `1.5px solid ${C.border}`, color: C.text, boxShadow: C.shadow, transition: "background 0.35s, border 0.35s" }}
              >
                ♪ My Playlist
                {playlist.length > 0 && (
                  <span className="flex items-center justify-center text-[10px] font-bold" style={{ background: C.accent, color: "white", width: 17, height: 17, borderRadius: "50%", lineHeight: 1 }}>
                    {playlist.length}
                  </span>
                )}
              </button>
              ...
              >
                <svg width="13" height="13" viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0 }}>
                  <path d="M12.5 2.5A6.5 6.5 0 1 0 13 7" stroke={C.accent} strokeWidth="1.7" strokeLinecap="round"/>
                  <path d="M10 2.5h2.5V5" stroke={C.accent} strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                Get Fresh Set
              </button>
            </div>
